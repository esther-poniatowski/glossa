"""
Sphinx configuration for Glossa API documentation.
...
# the cross-references autodoc generates (e.g. `#module-glossa.application.service`,
# `#glossa.application.service.LintService`) actually resolve on GitHub.
